#!/usr/bin/env bash
# Title: Waypoint Installer
# Description: This script automates the installation of HashiCorp Waypoint on Linux distributions. It detects the distribution type and installs Waypoint using the appropriate package manager and repository.
# Author: Jay-Alexander Elliot
# Date: 2024-01-23
# Usage: Run this script with root privileges. Usage: sudo ./waypoint_installer.sh
...
UB() {
    ...
    # Update package lists and install Waypoint
    sudo apt update && sudo apt-get install waypoint -y
}
